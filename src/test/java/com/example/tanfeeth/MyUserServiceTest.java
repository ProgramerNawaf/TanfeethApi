...
public class MyUserServiceTest {
    ...
    @BeforeEach
    void setUp() {
        myUser = new MyUser(null,"mo@gmail.com","1221","053054950","INNEED",true,null,null);
        myUser1 = new MyUser(null,"mo@gmail.com","1221","053054950","INNEED",true,null,null);
        myUser2 = new MyUser(null,"mo@gmail.com","1221","053054950","INNEED",true,null,null);
